...
const CollectionViewMain = ({type = "list"} : CollectionViewProps) => {
  ...
  const listView = () => {
    return (
      ...
      <div className={`${styles.textCardHoverOptContainer} ${onHoverCard(item) ? styles.show : ""}`}>
                <DeleteOutlined /><EditOutlined /><CopyOutlined /></div>
...
export default CollectionViewMain;
