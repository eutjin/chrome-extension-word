...
console.log("textform", textForm)
  ...
  return (
    <div className={styles.main1}>
      ...
      <CreateGroup open={openCreateGroupModal} onCloseModal={onCloseCreateGroupModal} />
      <CreateLabel open={openCreateLabelModal} onCloseModal={onCloseCreateLabelModal} />
      <div className={styles.groupTopNav}>
        <button className={styles.navButton} onClick={navigateHome}>
          <ArrowLeftOutlined />
        </button>
        <span>Text</span>
      ...
      <div className={styles.detail}>
        ...
        <div className={styles.displayBtnGroup}>
